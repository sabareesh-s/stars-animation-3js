...
class JumpToHyperspace {
  ...
  initiate = () => {
    ...
    TweenMax.to(this.STATE, 0.25, {velocity: VELOCITY_INIT_INC})
  ...
  jump = () => {
    ...
    TweenMax.to(this.STATE, 0.25, { velocity: JUMP_VELOCITY_INC, sizeInc: JUMP_SIZE_INC })
    setTimeout(() => {
      this.STATE = {
        ...this.STATE,
        jumping: false,
      }
      TweenMax.to(this.STATE, 0.25, { velocity: VELOCITY_INC, sizeInc: SIZE_INC })
    }, 2500)
  }
  enter = () => {
    ...
    if (new Date().getTime() - initiateTimestamp > 600) {
      ...
      TweenMax.to(this.STATE, 0.25, {velocity: VELOCITY_INC})
    }
  }
  bind = () => {
